...
##  프로젝트 개요
- **OnFit**은 사용자의 퍼스널 컬러(Personal Color)를 분석하여 개인에게 가장 잘 어울리는 패션 스타일을 제안하고, 웹상에서 의류를 직접 매칭해볼 수 있는 **사용자 맞춤형 쇼핑몰**입니다.
- 본 저장소는 팀 프로젝트의 **표준 버전**이며, 모든 팀원은 이 구조와 규칙을 준수해야 합니다.

### 기획 배경
- **온라인 쇼핑의 한계 극복**: 직접 착용해볼 수 없어 발생하는 색상·스타일 불일치 문제를 해결하고 반품률을 감소시킵니다.
- **퍼스널 컬러 트렌드 반영**: 대중화된 컬러 진단 트렌드를 웹 기술과 융합하여, 사용자에게 과학적이고 재미있는 개인 맞춤형 스타일링 가이드를 제공합니다.
- 
## ⚙️ 개발 환경 (Tech Stack)
- **Language**: Java 17
